...
% % Začetek dokaza
\begin{proof}
       V normalnem magičnem kvadratu reda $n$ je vsota vseh nastopajočih števil (glej \eqref{eq:numbers} na strani \pageref{eq:numbers}) enaka
...
\begin{equation}
   \label{eq:mc2}
   % oznaka: eq:mc
   \m_2(n;A,D) = \frac{1}{2} n \cdot (2A+D(n^2+1))
\end{equation}
